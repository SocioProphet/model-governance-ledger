.PHONY: validate validate-v0 validate-trustops-receipts validate-fraud-decision-ledger test release-dry-run

validate: validate-v0 validate-trustops-receipts validate-fraud-decision-ledger
